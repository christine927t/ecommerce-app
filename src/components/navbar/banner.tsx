    ...
    return (
        <div className="banner h-[30px] md:h-[40px] px-4 text-white text-[10px] md:text-[13px] w-100% flex items-center justify-between">
            ...
            <button onClick={() => setIsVisible(false)} aria-label="Close banner" className="ms-auto cursor-pointer">
                <svg height="10px" width="10px" viewBox="0 0 10 10" aria-label="close"><g stroke="currentColor" strokeWidth="1.1"><path d="M8.695 1.095l-7.6 7.6" strokeWidth="1.1"></path><path d="M8.695 8.695l-7.6-7.6" strokeWidth="1.1"></path></g></svg>
            </button>
        </div>
    )
}