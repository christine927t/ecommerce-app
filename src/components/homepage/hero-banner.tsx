...
export default function HeroBanner() {
    return (
        <div className="hero-banner relative">
            ...
            <div className="absolute inset-x-0 bottom-[80px] text-center text-white">
                <p className="font-semibold text-[32px] pb-2">BEST SELLERS</p>
                <p className="px-8">The most Awesome to ever do it. Forever-favorite styles and silhouettes—appropriately hyped, undeniably iconic.</p>
                <ShopNowCTA />
            </div>
        </div>
    )
